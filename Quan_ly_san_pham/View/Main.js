            ...
            <tr>
                <td>
                    <table>
                        ...
                        <tr>
                            <td style="font-size: 20px; text-align: center">${productOfstore[i].price} đ</td>
                        </tr>
                        <tr>
                            <th>
...
//     <td>${productOfstore[i].id}</td>
//     <td>${productOfstore[i].name}</td>
//     <td><img src="${productOfstore[i].img}" alt="" style="width: 50px; height: 50px"></td>
//     <td style="text-align: center">${productOfstore[i].quantity}</td>
//     <td>${productOfstore[i].unit}</td>
//     <td>${productOfstore[i].price}</td>
//     <td>
//         <button style="background: #e01818" onClick="remove(${i})">Del</button>
//     </td>
//     <td>
//         <button style="background: #1616a4" onClick="showFormEdit(${i})">Edit</button>
//     </td>
// </tr>
...
function searchProduct() {
    ...
    for (let i = 0; i < productOfstore.length ; i++) {
        ...
        <td>${productOfstore[i].id}</td>
        <td>${productOfstore[i].name}</td>
        <td><img style = "width: 50px; height: 50px" src="${productOfstore[i].img}" alt=""></td>
        <td style="text-align: center">${productOfstore[i].quantity}</td>
        <td>${productOfstore[i].unit}</td>
        <td>${productOfstore[i].price}</td>
        <td><button style="background: #e01818" onclick="remove(${i})">Del</button></td>
